...
URL = "https://unknown-cinema-68f1fa587a07.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://unknown-cinema-68f1fa587a07.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://unknown-cinema-68f1fa587a07.herokuapp.com/".format(FQDN)
else:
    URL = "https://unknown-cinema-68f1fa587a07.herokuapp.com/".format(FQDN)
